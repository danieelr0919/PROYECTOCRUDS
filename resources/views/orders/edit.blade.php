...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="text-warning">Editar Pedido</h1>
        ...
        <form action="{{ route('orders.update', $order->id) }}" method="POST" class="card shadow-sm">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="total_amount" name="total_amount" value="{{ old('total_amount', $order->total_amount) }}" required>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card-footer d-flex justify-content-end gap-2">
                ...
                <a href="{{ route('orders.show', $order->id) }}" class="btn btn-outline-primary">Ver</a>
