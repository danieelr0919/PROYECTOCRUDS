...
<body>
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h3 mb-0">Detalle del Pedido</h1>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3 text-muted">Número de Pedido</div>
                    <div class="col-md-9">{{ $order->order_number }}</div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3 text-muted">Cliente</div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3 text-muted">Monto Total</div>
                    <div class="col-md-9"><span class="badge bg-success">$ {{ number_format($order->total_amount, 2) }}</span></div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3 text-muted">Estado</div>
                    <div class="col-md-9"><span class="badge text-bg-secondary text-capitalize">{{ $order->status }}</span></div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3 text-muted">Fecha</div>
                    <div class="col-md-9">{{ \Illuminate\Support\Carbon::parse($order->order_date)->format('Y-m-d') }}</div>
                </div>
                <div class="row">
                    <div class="col-12 d-flex gap-2">
                        ...
                        <a href="{{ route('orders.index') }}" class="btn btn-outline-secondary">Volver al Listado</a>
                    </div>
                </div>
            </div>
        </div>
